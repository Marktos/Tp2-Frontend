    ...
    window.fetch = function (url, opts: any): Promise<Response> {
        return new Promise((resolve, reject) => {
            ...
            function handleRoute() {
                ...
                switch (true) {
                    ...
                    case url.toString().endsWith('/users') && method === 'GET':
                        return getUsers();
                    default:
                        // Si ningun caso anterior corresponde llegamos a esta instancia
            ...
            function unauthorized() {
                resolve({ status: 401, text: () => Promise.resolve(JSON.stringify({ message: 'No tienes autorizacion' })) } as Response);
            }
